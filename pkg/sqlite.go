...
func (dao *SiteConfigDao) DeleteOne(id int) error {
...
func (dao *SiteConfigDao) GetAll() ([]SiteConfig, error) {
...
func (dao *SiteConfigDao) addOne(data SiteConfig) error {
...
func (dao *SiteConfigDao) UpdateById(data SiteConfig) error {
...
func (dao *SiteConfigDao) GetByPage(page, limit int) ([]SiteConfig, error) {
	start := (page - 1) * limit
...
func (dao *SiteConfigDao) AddMulti(configs []SiteConfig) error {
	tx, err := dao.db.Begin()
	if err != nil {
		return err
	}
...
func (dao *SiteConfigDao) MultiDel(domains []string) error {
...
func (dao *SiteConfigDao) Count() (int, error) {
...
func (dao *SiteConfigDao) ForbiddenWordReplace(forbiddenWord, replaceWord, splitWord string) ([]string, error) {
